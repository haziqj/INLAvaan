...
fit_lav  <- cfa(mod, dat, std.lv = STDLV, parser = "old")
# fit_blav <- bcfa(mod, dat, bcontrol = list(cores = 3), burnin = nsamp / 2, sample = nsamp)
fit_inl1 <- inlavaan(mod, dat, lavfun = "cfa", method = "skewnorm")
# fit_inl2 <- inlavaan(mod, dat, lavfun = "cfa", method = "asymgaus")
# fit_inl3 <- inlavaan(mod, dat, lavfun = "cfa", method = "marggaus")
fit_inl4 <- inlavaan(mod, dat, lavfun = "cfa", method = "sampling")
