...
#> ✔ Performing VB correction. [413ms]
#> 
#> ⠙ Fitting skew normal to 0/17 marginals.
#> ✔ Fitting skew normal to 17/17 marginals. [1.8s]
#> 
#> ℹ Sampling covariances and defined parameters.
#> ✔ Sampling covariances and defined parameters. [63ms]
#> 
#> ⠙ Computing ppp and DIC.
#> ✔ Computing ppp and DIC. [250ms]
#> 
summary(fit)
...
#> 
#>    Deviance (DIC)                             4996.774 
#>    Effective parameters (pD)                    17.212 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.153    0.042   -0.014    0.149    0.005       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
