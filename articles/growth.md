...
#> ✔ VB correction; mean |δ| = 0.051σ. [234ms]
#> 
...
#> ✔ Summarise 100 posterior draws. [521ms]
#> 
...
#> 
#>    Deviance (DIC)                             4995.134 
#>    Effective parameters (pD)                    16.367 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.076    0.036    0.006    0.146    0.006       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
