...
#>    PPP (Chi-square)                              0.800 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                             5011.532 
#>    Effective parameters (pD)                    24.592 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.161    0.030    0.017    0.137    0.004       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
