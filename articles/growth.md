...
#> ✔ VB correction; mean |δ| = 0.051σ. [393ms]
#> 
...
#> ✔ Summarise 100 posterior draws. [496ms]
#> 
#> ℹ Fit measures: PPP, DIC, LOO, WAIC.
summary(fit)
#> INLAvaan 0.3.0.9000 ended normally after 83 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                             4995.037 
#>    Effective parameters (pD)                    16.318 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.079    0.035    0.011    0.148    0.006       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
