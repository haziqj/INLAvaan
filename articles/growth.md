...
#> ✔ VB correction; mean |δ| = 0.032σ. [351ms]
#> 
...
#> ✔ Summarise 100 posterior draws. [463ms]
#> 
...
#> 
#>    Deviance (DIC)                             4995.440 
#>    Effective parameters (pD)                    16.553 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.074    0.036    0.004    0.144    0.006       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
