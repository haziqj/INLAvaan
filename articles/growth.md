...
#> ✔ VB correction; mean |δ| = 0.051σ. [239ms]
#> 
...
#> ✔ Summarise 100 posterior draws. [522ms]
#> 
...
#> 
#>    Deviance (DIC)                             4997.275 
#>    Effective parameters (pD)                    17.437 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.083    0.043   -0.001    0.166    0.006       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
