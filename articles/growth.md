...
#> ✔ VB correction; mean |δ| = 0.004. [266ms]
#> 
...
#> 
#>    Deviance (DIC)                             5003.520 
#>    Effective parameters (pD)                    20.586 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.153    0.041    0.155   -0.006    0.005       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
