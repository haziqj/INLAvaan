...
#> ✔ VB correction; mean |δ| = 0.032σ. [342ms]
#> 
...
#> ✔ Summarise 100 posterior draws. [450ms]
#> 
...
#> 
#>    Deviance (DIC)                             4995.833 
#>    Effective parameters (pD)                    16.749 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.080    0.037    0.008    0.152    0.006       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
