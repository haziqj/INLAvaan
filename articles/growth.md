...
#> ✔ Sampling covariances and defined parameters. [486ms]
#> 
...
#> 
#>    Deviance (DIC)                             4996.153 
#>    Effective parameters (pD)                    16.901 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.153    0.042   -0.010    0.156    0.005       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
