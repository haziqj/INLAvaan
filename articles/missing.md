...
#> ✔ VB correction; mean |δ| = 0.223σ. [557ms]
#> 
#> ⠙ Fitting 0/42 skew-normal marginals.
#> ⠹ Fitting 19/42 skew-normal marginals.
#> ✔ Fit 42/42 skew-normal marginals. [2.7s]
#> 
...
#> ✔ Posterior mode and Hessian. [547ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.194σ. [648ms]
#> 
#> ⠙ Fitting 0/42 skew-normal marginals.
#> ⠹ Fitting 12/42 skew-normal marginals.
#> ⠸ Fitting 30/42 skew-normal marginals.
#> ✔ Fit 42/42 skew-normal marginals. [5.2s]
#> 
...
#> Warning in sqrt(Vx): NaNs produced
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [226ms]
#> 
#> ⠙ Posterior sampling and summarising.
