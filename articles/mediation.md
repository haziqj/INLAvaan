...
#> ✔ VB correction; mean |δ| = 0.084σ. [175ms]
#> 
#> ⠙ Fitting 0/7 skew-normal marginals.
#> ✔ Fitting 7/7 skew-normal marginals. [172ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjusting copula correlations (NORTA). [17ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Posterior sampling and summarising. [524ms]
#> 
```
...
``` r
summary(fit)
#> INLAvaan 0.2.3.9019 ended normally after 5 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                              568.327 
#>    Effective parameters (pD)                     6.717 
#> 
#> Parameter Estimates:
#> 
