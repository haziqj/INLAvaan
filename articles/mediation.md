...
#> ✔ Fitting skew normal to 7/7 marginals. [356ms]
#> 
...
#> 
#>    Deviance (DIC)                              569.020 
#>    Effective parameters (pD)                     7.051 
#> 
#> Parameter Estimates:
#> 
...
#> Defined Parameters:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>     ab                0.406    0.100    0.238    0.611                         
#>     total             0.345    0.139    0.075    0.613
```
