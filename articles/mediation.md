...
#> ✔ Fitting skew normal to 7/7 marginals. [363ms]
#> 
...
#> 
#>    Deviance (DIC)                              568.757 
#>    Effective parameters (pD)                     6.919 
#> 
#> Parameter Estimates:
#> 
...
#> Defined Parameters:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>     ab                0.401    0.101    0.218    0.596                         
#>     total             0.331    0.129    0.060    0.573
```
