...
#> ✔ VB correction; mean |δ| = 0.176σ. [228ms]
#> 
#> ⠙ Fitting 0/28 skew-normal marginals.
#> ✔ Fitting 28/28 skew-normal marginals. [1.5s]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjusting copula correlations (NORTA). [205ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ⠹ Posterior sampling and summarising.
#> ✔ Posterior sampling and summarising. [683ms]
#> 
summary(fit)
...
#> 
#>    Deviance (DIC)                             3153.046 
#>    Effective parameters (pD)                    27.356 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .y1 ~~                                                                        
#>    .y5                0.276    0.370   -0.040    1.413    0.003       beta(1,1)
#>  .y2 ~~                                                                        
#>    .y4                0.272    0.689    0.224    2.930    0.007       beta(1,1)
#>    .y6                0.343    0.759    0.859    3.837    0.012       beta(1,1)
#>  .y3 ~~                                                                        
#>    .y7                0.179    0.639   -0.444    2.062    0.006       beta(1,1)
#>  .y4 ~~                                                                        
#>    .y8                0.106    0.477   -0.467    1.405    0.004       beta(1,1)
#>  .y6 ~~                                                                        
#>    .y8                0.313    0.578    0.277    2.548    0.005       beta(1,1)
#> 
#> Variances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
