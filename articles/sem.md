...
#> ✔ Performing VB correction. [617ms]
#> 
...
#>    PPP (Chi-square)                              0.135 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                             3225.970 
#>    Effective parameters (pD)                    63.769 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .y1 ~~                                                                        
#>    .y5                0.281    0.371    0.023    1.473    0.005       beta(1,1)
#>  .y2 ~~                                                                        
#>    .y4                0.274    0.716    0.183    2.992    0.009       beta(1,1)
#>    .y6                0.343    0.745    0.922    3.847    0.011       beta(1,1)
#>  .y3 ~~                                                                        
#>    .y7                0.184    0.650   -0.418    2.129    0.011       beta(1,1)
#>  .y4 ~~                                                                        
#>    .y8                0.107    0.471   -0.470    1.379    0.010       beta(1,1)
#>  .y6 ~~                                                                        
#>    .y8                0.312    0.562    0.261    2.468    0.013       beta(1,1)
#> 
#> Variances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
