...
#>    PPP (Chi-square)                              0.142 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                             3226.298 
#>    Effective parameters (pD)                    63.947 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .y1 ~~                                                                        
#>    .y5                0.275    0.393   -0.042    1.496    0.003       beta(1,1)
#>  .y2 ~~                                                                        
#>    .y4                0.271    0.740    0.143    3.044    0.006       beta(1,1)
#>    .y6                0.344    0.779    0.816    3.875    0.010       beta(1,1)
#>  .y3 ~~                                                                        
#>    .y7                0.179    0.635   -0.374    2.122    0.005       beta(1,1)
#>  .y4 ~~                                                                        
#>    .y8                0.104    0.467    1.301   -0.530    0.003       beta(1,1)
#>  .y6 ~~                                                                        
#>    .y8                0.316    0.554    0.291    2.467    0.005       beta(1,1)
#> 
#> Variances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
