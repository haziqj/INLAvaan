...
#> ✔ VB correction; mean |δ| = 0.045σ. [241ms]
#> 
#> ⠙ Fitting skew normal to 0/28 marginals.
#> ⠹ Fitting skew normal to 8/28 marginals.
...
#> 
#>    Deviance (DIC)                             3223.975 
#>    Effective parameters (pD)                    62.785 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .y1 ~~                                                                        
#>    .y5                0.273    0.388   -0.001    1.515    0.005       beta(1,1)
#>  .y2 ~~                                                                        
#>    .y4                0.274    0.680    0.231    2.899    0.007       beta(1,1)
#>    .y6                0.342    0.793    0.802    3.916    0.016       beta(1,1)
#>  .y3 ~~                                                                        
#>    .y7                0.182    0.658   -0.294    2.288    0.007       beta(1,1)
#>  .y4 ~~                                                                        
#>    .y8                0.110    0.468   -0.551    1.283    0.006       beta(1,1)
#>  .y6 ~~                                                                        
#>    .y8                0.316    0.581    0.218    2.497    0.007       beta(1,1)
#> 
#> Variances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
