...
#> 
#>    Deviance (DIC)                             7735.137 
#>    Effective parameters (pD)                   184.861 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>   visual ~~                                                                    
#>     textual           0.468    0.109    0.669    0.242    0.004       beta(1,1)
#>     speed             0.306    0.071    0.028    0.306    0.010       beta(1,1)
#>   textual ~~                                                                   
#>     speed             0.311    0.067    0.299    0.037    0.002       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>   visual ~~                                                                    
#>     textual           0.516    0.093    0.568    0.205    0.002       beta(1,1)
#>     speed             0.503    0.073    0.397    0.113    0.007       beta(1,1)
#>   textual ~~                                                                   
#>     speed             0.320    0.074    0.071    0.360    0.007       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
...
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.019σ. [491ms]
#> 
...
#>   fit3        48   -3913.733 7666.622 126.5509   0.000
#>   fit2        54   -3934.223 7605.191 115.8188 -20.490
#>   fit1        60   -3957.428 7735.137 184.8610 -43.694
```
