...
#> ✖ The VB correction shifted `y2|t1` by 1.06 posterior SDs; the Gaussian
...
#> 
#>    Marginal log-likelihood                   -1108.234 
#>    PPP (Chi-square)                              0.000 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                             2154.365 
#>    Effective parameters (pD)                     6.951 
#> 
#> Parameter Estimates:
#> 
...
#>     y2                1.871    0.515    1.212    3.061                       
#>     y3                1.204    0.121    1.039    1.501                       
#>     y4                1.053    0.051    1.000    1.194                       
#>     y5                1.266    0.166    1.052    1.686
