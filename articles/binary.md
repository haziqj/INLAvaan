...
#> ✔ VB correction; mean |δ| = 0.134σ. [417ms]
#> 
#> ⠙ Fitting 0/10 skew-normal marginals.
#> ✔ Fitting 10/10 skew-normal marginals. [449ms]
#> 
...
#> ⠹ Posterior sampling and summarising.
#> ✔ Posterior sampling and summarising. [540ms]
#> 
summary(fit)
#> INLAvaan 0.2.3.9010 ended normally after 37 iterations
#> 
#>   Estimator                                      BAYES
