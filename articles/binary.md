...
#> ✔ Posterior mode and Hessian. [185ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.370σ. [2.9s]
#> 
#> ⠙ Fitting 0/10 skew-normal marginals.
#> ✔ Fit 10/10 skew-normal marginals. [539ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [30ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Summarise 1000 posterior draws. [930ms]
#> 
#> ℹ Fit measures: PPP, DIC.
summary(fit)
#> INLAvaan 0.3.1.9008 ended normally after 44 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Marginal log-likelihood                   -1108.258 
#>    PPP (Chi-square)                              0.000 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                             2154.508 
#>    Effective parameters (pD)                     7.025 
#> 
#> Parameter Estimates:
#> 
