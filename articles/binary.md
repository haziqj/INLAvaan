...
#> ✔ Posterior mode and Hessian. [195ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.397σ. [447ms]
#> 
#> ⠙ Fitting 0/10 skew-normal marginals.
#> ✔ Fit 10/10 skew-normal marginals. [621ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [35ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Summarise 1000 posterior draws. [913ms]
#> 
