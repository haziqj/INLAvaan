...
#> ✔ Posterior mode and Hessian. [739ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.123σ. [362ms]
#> 
...
#> ⠸ Computing WAIC.
#> ✔ Summarise 1000 posterior draws. [44.6s]
#> 
...
#> 
#>    Deviance (DIC)                            24192.521 
#>    Effective parameters (pD)                    19.611 
#> 
#> Parameter Estimates:
#> 
