...
#> ✔ Posterior mode and Hessian. [719ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.123σ. [357ms]
#> 
...
#> ⠹ Computing WAIC.
#> ✔ Summarise 1000 posterior draws. [43.6s]
#> 
...
#> 
#>    Deviance (DIC)                            24192.468 
#>    Effective parameters (pD)                    19.584 
#> 
#> Parameter Estimates:
#> 
