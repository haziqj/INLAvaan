...
#> ✔ VB correction; mean |δ| = 0.032σ. [398ms]
#> 
...
#> ✔ Adjusting copula correlations (NORTA). [119ms]
#> 
...
``` r
summary(fit)
#> INLAvaan 0.2.3.9016 ended normally after 108 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                            24191.767 
#>    Effective parameters (pD)                    19.234 
#> 
#> Parameter Estimates:
#> 
