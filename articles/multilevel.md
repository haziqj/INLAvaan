...
#> ✔ Finding posterior mode. [554ms]
#> 
#> ℹ Computing the Hessian.
#> ✔ Computing the Hessian. [687ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.021σ. [825ms]
#> 
...
#> 
#>    Deviance (DIC)                            24269.380 
#>    Effective parameters (pD)                    58.074 
#> 
#> Parameter Estimates:
#> 
