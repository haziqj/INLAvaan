...
#> ✔ VB correction; mean |δ| = 0.019σ. [394ms]
#> 
#> ⠙ Fitting skew-normal to 0/20 marginals.
#> ⠹ Fitting skew-normal to 12/20 marginals.
#> ✔ Fitting skew-normal to 20/20 marginals. [1.7s]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjusting copula correlations (NORTA). [161ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Posterior sampling and summarising. [736ms]
#> 
```
...
``` r
summary(fit)
#> INLAvaan 0.2.3.9008 ended normally after 108 iterations
#> 
#>   Estimator                                      BAYES
...
#>    PPP (Chi-square)                              0.006 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                            24240.336 
#>    Effective parameters (pD)                    43.569 
#> 
#> Parameter Estimates:
#> 
...
#> Variances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .y1                0.985    0.046    1.076    0.896    0.003 gamma(1,.5)[sd]
#>    .y2                1.067    0.039    1.146    0.992    0.001 gamma(1,.5)[sd]
#>    .y3                1.012    0.037    1.085    0.942    0.001 gamma(1,.5)[sd]
#>    .fw                0.547    0.041    0.629    0.470    0.004 gamma(1,.5)[sd]
#> 
#> 
#> Level 2 [cluster]:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>   fb ~                                                                         
#>     w1                0.161    0.079    0.007    0.315    0.001    normal(0,10)
#>     w2                0.126    0.076   -0.023    0.276    0.001    normal(0,10)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
...
#> Variances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .y1                0.069    0.042    1.203    0.008    0.091 gamma(1,.5)[sd]
#>    .y2                0.126    0.031    0.333    0.070    0.008 gamma(1,.5)[sd]
#>    .y3                0.154    0.029    0.291    0.103    0.002 gamma(1,.5)[sd]
...
- **Level 2 \[cluster\] Regressions**
  ...
  The path `fb ~ w1` is 0.161 This suggests a positive relationship
