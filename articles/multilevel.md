...
#> ✔ Posterior mode and Hessian. [717ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.123σ. [361ms]
#> 
...
#> ⠹ Computing WAIC.
#> ✔ Summarise 1000 posterior draws. [43.8s]
#> 
...
#> 
#>    Deviance (DIC)                            24192.259 
#>    Effective parameters (pD)                    19.480 
#> 
#> Parameter Estimates:
#> 
