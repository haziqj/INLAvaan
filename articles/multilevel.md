...
``` r
summary(fit)
#> INLAvaan 0.2.4 ended normally after 108 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                            24192.353 
#>    Effective parameters (pD)                    19.527 
#> 
#> Parameter Estimates:
#> 
