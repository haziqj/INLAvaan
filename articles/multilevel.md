...
#> ✔ Posterior mode and Hessian. [730ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.123σ. [393ms]
#> 
#> ⠙ Fitting 0/20 skew-normal marginals.
#> ⠹ Fitting 8/20 skew-normal marginals.
#> ✔ Fit 20/20 skew-normal marginals. [2.9s]
#> 
...
#> ⠸ Computing WAIC.
#> ✔ Summarise 1000 posterior draws. [52.3s]
#> 
...
#>    PPP (Chi-square)                              0.037 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                            24192.223 
#>    Effective parameters (pD)                    19.462 
#> 
#> Parameter Estimates:
#> 
