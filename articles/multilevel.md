...
#> ✔ VB correction; mean |δ| = 0.054σ. [810ms]
#> 
...
#> ✔ Summarise 1000 posterior draws. [5.4s]
#> 
...
summary(fit)
#> INLAvaan 0.3.1.9010 ended normally after 108 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                            24191.869 
#>    Effective parameters (pD)                    19.338 
#> 
#> Parameter Estimates:
#> 
