...
``` r
summary(fit)
#> INLAvaan 0.2.3.9019 ended normally after 108 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                            24192.241 
#>    Effective parameters (pD)                    19.471 
#> 
#> Parameter Estimates:
#> 
