...
#> ✔ Posterior mode and Hessian. [723ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.054σ. [894ms]
#> 
...
summary(fit)
#> INLAvaan 0.3.1.9012 ended normally after 108 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                            24193.133 
#>    Effective parameters (pD)                    19.970 
#> 
#> Parameter Estimates:
#> 
