...
#> ✔ Posterior mode and Hessian. [699ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.123σ. [321ms]
#> 
#> ⠙ Fitting 0/20 skew-normal marginals.
#> ⠹ Fitting 10/20 skew-normal marginals.
#> ✔ Fit 20/20 skew-normal marginals. [2.3s]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [114ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Summarise 1000 posterior draws. [5.3s]
#> 
...
summary(fit)
#> INLAvaan 0.3.1.9005 ended normally after 108 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                            24192.052 
#>    Effective parameters (pD)                    19.376 
#> 
#> Parameter Estimates:
#> 
