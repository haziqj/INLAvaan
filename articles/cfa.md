...
#> ✔ VB correction; mean |δ| = 0.081σ. [134ms]
#> 
#> ⠙ Fitting 0/21 skew-normal marginals.
#> ✔ Fit 21/21 skew-normal marginals. [883ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [144ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Summarise 100 posterior draws. [318ms]
#> 
...
#> 
#>    Deviance (DIC)                             7551.357 
#>    Effective parameters (pD)                    20.105 
#> 
#> Parameter Estimates:
#> 
