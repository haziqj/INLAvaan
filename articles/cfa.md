...
#> ✔ Performing VB correction. [117ms]
#> 
#> ⠙ Fitting skew normal to 0/21 marginals.
#> ✔ Fitting skew normal to 21/21 marginals. [630ms]
#> 
#> ⠙ Computing ppp and DIC.
#> ⠹ Computing ppp and DIC.
#> ✔ Computing ppp and DIC. [90ms]
#> 
summary(fit)
...
#> 
#>    Deviance (DIC)                             7551.063 
#>    Effective parameters (pD)                    37.657 
#> 
#> Parameter Estimates:
#> 
...
#> Variances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .x1                0.558    0.121    0.825    0.351    0.001 gamma(1,.5)[sd]
