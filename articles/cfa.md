...
#> ✔ VB correction; mean |δ| = 0.081σ. [160ms]
#> 
#> ⠙ Fitting 0/21 skew-normal marginals.
#> ✔ Fit 21/21 skew-normal marginals. [890ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [134ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Summarise 100 posterior draws. [333ms]
#> 
...
#> 
#>    Deviance (DIC)                             7554.320 
#>    Effective parameters (pD)                    21.587 
#> 
#> Parameter Estimates:
#> 
