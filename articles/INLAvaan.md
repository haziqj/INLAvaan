...
#> ✔ VB correction; mean |δ| = 0.055σ. [110ms]
#> 
#> ⠙ Fitting 0/13 skew-normal marginals.
#> ✔ Fitting 13/13 skew-normal marginals. [336ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjusting copula correlations (NORTA). [78ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Posterior sampling and summarising. [506ms]
#> 
```
...
fit
#> INLAvaan 0.2.3.9020 ended normally after 62 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.036σ. [70ms]
#> 
