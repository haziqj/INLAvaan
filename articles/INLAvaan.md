...
fit
#> INLAvaan 0.2.3.9020 ended normally after 76 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.037σ. [104ms]
#> 
#> ⠙ Fitting 0/12 skew-normal marginals.
#> ✔ Fitting 12/12 skew-normal marginals. [301ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
