...
#> ✔ Posterior mode and Hessian. [300ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.057σ. [129ms]
#> 
#> ⠙ Fitting 0/13 skew-normal marginals.
#> ✔ Fit 13/13 skew-normal marginals. [433ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [61ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Summarise 1000 posterior draws. [962ms]
#> 
...
fit
#> INLAvaan 0.3.1.9000 ended normally after 67 iterations
#> 
#>   Estimator                                      BAYES
