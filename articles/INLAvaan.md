...
#> ✔ VB correction; mean |δ| = 0.031σ. [315ms]
#> 
...
#> ✔ Summarise 1000 posterior draws. [732ms]
#> 
...
fit
#> INLAvaan 0.3.1.9008 ended normally after 67 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Marginal log-likelihood                   -8087.692 
...
#> 
#>    Deviance (DIC)                            16069.130 
#>    Effective parameters (pD)                    13.047 
#> 
#> Parameter Estimates:
#> 
...
head(eta_preds[[1]])
#>            eta1       eta2
#> [1,]  1.3122168 -0.6442397
#> [2,]  0.8283062  0.1907448
#> [3,] -0.9596622 -1.3654705
#> [4,]  0.4597378 -0.2671696
#> [5,]  2.6768664 -1.9584213
#> [6,] -1.6853528 -0.8620067
```
...
#>   .. ..$ : NULL
#>   .. ..$ : chr [1:2] "eta1" "eta2"
#>  $ 2.5%    : num [1:1000, 1:2] 0.242604 0.000172 -2.218306 -0.845334 0.73992 ...
#>   ..- attr(*, "dimnames")=List of 2
#>   .. ..$ : NULL
#>   .. ..$ : chr [1:2] "eta1" "eta2"
#>  $ 50%     : num [1:1000, 1:2] 0.9402 0.7719 -1.1422 -0.0583 1.5401 ...
#>   ..- attr(*, "dimnames")=List of 2
#>   .. ..$ : NULL
#>   .. ..$ : chr [1:2] "eta1" "eta2"
...
head(summ_eta$Mean)
#>             eta1        eta2
#> [1,]  1.01258809 -0.02555366
#> [2,]  0.78911000 -0.31071537
#> [3,] -1.18337069 -1.31371692
#> [4,] -0.01653279 -0.02200033
#> [5,]  1.51507023 -1.39226115
#> [6,] -1.82623221 -0.98908589
```
...
head(yrep[[1]])
#>           y1         y2         y3          y4         y5          y6
#> 1  1.5679385  0.8827172  0.7631336 -1.23900713 -1.6062390  0.01279657
#> 2 -1.4739535 -0.9360022 -2.0045420 -1.29879080 -2.2035645 -0.91358023
#> 3  3.3207961  1.5550146  1.1964581 -0.07288806 -0.9709730  1.00237242
#> 4  0.4784914  0.6555458  0.4348603 -1.60925182 -0.3261864  1.35692935
#> 5  2.0142140  1.2003548  1.6534184  1.43431550  1.8564701  1.92471102
#> 6  0.3214047 -0.9952219  0.1368011  0.77905598  0.7094502  1.31313172
```
...
#>           13    -8087.692        0.123    16069.130       13.047        0.071 
#>    BGammaHat adjBGammaHat          BMc     elpd_loo        p_loo        looic 
#>        0.987        0.965        0.980    -8024.734       12.839    16049.468 
#>       se_loo    elpd_waic       p_waic         waic      se_waic 
#>      108.641    -8024.733       12.838    16049.466      108.641
```
...
#>       6.34e-03       7.43e-03       5.50e-04       3.53e+01              1 
#>  vb_kld_global        kld_max       kld_mean    vb_mcse_max   vb_mcse_mean 
#>         6.4602         0.0019         0.0007         0.0322         0.0122 
#>       nmad_max      nmad_mean 
#>         0.0071         0.0036
```
...
fit2 <- asem(mod2, dat)
#> ℹ Mode finding and Hessian computation.
#> ✔ Posterior mode and Hessian. [125ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.034σ. [253ms]
#> 
#> ⠙ Fitting 0/12 skew-normal marginals.
#> ✔ Fit 12/12 skew-normal marginals. [355ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [54ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ⠹ Computing fit indices (PPP/DIC).
#> ✔ Summarise 1000 posterior draws. [751ms]
#> 
#> ℹ Fit measures: PPP, DIC, LOO, WAIC.
compare(fit, fit2)
...
#>    fit   13   -8087.692   0.000 16069.13 13.047
#>   fit2   12   -8107.901 -20.209 16120.33 12.173
```
...
#> looic     16049.5 108.6
#> 
#> ── Curvature check ──────────────────────────────────────────── 1000 subjects ──
#>   first-to-second-order gap         6.6
#>   pD/2 (trace)                      6.5
#>   excess over pD/2 (trace)        +1.3%
#> 
...
#>    fit   13   -8087.692   0.000 16069.13 13.047 -8024.734 54.320 12.839
#>   fit2   12   -8107.901 -20.209 16120.33 12.173 -8050.232 54.549 11.842
#>  elpd_diff se_diff
#>      0.000    0.00
#>    -25.498    7.28
```
