...
#> ✔ VB correction; mean |δ| = 0.057σ. [186ms]
#> 
#> ⠙ Fitting 0/13 skew-normal marginals.
#> ✔ Fit 13/13 skew-normal marginals. [624ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [99ms]
#> 
...
fit
#> INLAvaan 0.3.0 ended normally after 67 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.037σ. [126ms]
#> 
#> ⠙ Fitting 0/12 skew-normal marginals.
#> ✔ Fit 12/12 skew-normal marginals. [415ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjust copula correlations (NORTA). [60ms]
#> 
#> ⠙ Posterior sampling and summarising.
