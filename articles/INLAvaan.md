...
#> 
#>    Marginal log-likelihood                   -8087.559 
...
#> 
#>    Deviance (DIC)                            16069.086 
#>    Effective parameters (pD)                    13.026 
#> 
#> Parameter Estimates:
#> 
...
head(summ_eta$Mean)
#>            eta1        eta2
#> [1,]  1.0125834 -0.02554947
#> [2,]  0.7891053 -0.31072360
#> [3,] -1.1833602 -1.31371021
#> [4,] -0.0165399 -0.02200646
#> [5,]  1.5150658 -1.39225929
#> [6,] -1.8262214 -0.98909415
```
...
head(yrep[[1]])
#>           y1         y2         y3          y4          y5         y6
#> 1  1.0921235  0.8570852  0.3248556 -1.56578011 -1.88216890 -0.1900871
#> 2  2.6302141  0.6240689  1.1401699  1.81132802  0.44535951  1.0447431
#> 3  0.1551629 -0.2202393 -0.9567078 -2.60280316 -3.12134784 -0.5908424
#> 4  0.2304407  0.2176542  0.4082373 -1.87632098 -0.54828777  1.1860368
#> 5 -2.6920346 -1.3857940 -1.5732350 -2.31303979 -1.33177160 -0.4388961
#> 6 -1.0996823 -0.3760965 -1.5036383 -0.03817937  0.01396096  0.8080365
```
...
match the joint posterior (via KL divergence and NMAD), including how
much mass a fitted marginal leaves beyond the window that was scanned to
fit it (`scan_end_mass_max`). Per-parameter diagnostics
(`type = "param"`) provide gradient norms and KL contributions for each
free parameter, which is useful for identifying any problematic
parameters.
