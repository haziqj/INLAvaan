...
#> ✔ VB correction; mean |δ| = 0.057σ. [97ms]
#> 
...
fit
#> INLAvaan 0.2.4.9000 ended normally after 76 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#> ℹ Computing the Hessian.
#> ✔ Computing the Hessian. [31ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.037σ. [66ms]
#> 
#> ⠙ Fitting 0/12 skew-normal marginals.
#> ✔ Fitting 12/12 skew-normal marginals. [207ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjusting copula correlations (NORTA). [53ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Posterior sampling and summarising. [383ms]
#> 
compare(fit, fit2)
