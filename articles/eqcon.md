...
#> ✔ VB correction; mean |δ| = 0.172σ. [337ms]
#> 
...
#> ✔ Computing Taylor LOO. [189ms]
#> 
#> ℹ Computing WAIC from the posterior draws.
#> ✔ Computing WAIC from the posterior draws. [176ms]
#> 
coef(fit)
#>      i~~i       i~1      s~~s       s~1      i~~s         v         v         v 
#> 12103.397    32.694    38.488     9.351   101.475   622.801   622.801   622.801 
#>         v         v         v         v         v         v         v 
