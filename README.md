...
#> ✔ Fitting skew normal to 31/31 marginals. [692ms]
#> 
...
#>    PPP (Chi-square)                              0.146 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                             3228.740 
#>    Effective parameters (pD)                    65.687 
#> 
#> Parameter Estimates:
#> 
...
#>     x3                1.825    0.159    1.525    2.149    0.008    normal(0,10)
#>   dem60 =~                                                                     
#>     y1                1.000                                                    
#>     y2                1.353    0.215    0.959    1.804    0.008    normal(0,10)
#>     y3                1.121    0.169    0.808    1.471    0.007    normal(0,10)
#>     y4                1.363    0.176    1.045    1.737    0.010    normal(0,10)
#>   dem65 =~                                                                     
#>     y5                1.000                                                    
#>     y6                1.216    0.186    0.880    1.609    0.010    normal(0,10)
#>     y7                1.318    0.175    1.004    1.690    0.013    normal(0,10)
#>     y8                1.313    0.179    0.992    1.695    0.012    normal(0,10)
#> 
#> Regressions:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>   dem60 ~                                                                      
#>     ind60             1.466    0.381    0.738    2.234    0.004    normal(0,10)
#>   dem65 ~                                                                      
#>     ind60             0.570    0.245    0.099    1.060    0.002    normal(0,10)
#>     dem60             0.872    0.113    0.667    1.110    0.013    normal(0,10)
#> 
#> Covariances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .y1 ~~                                                                        
#>    .y5                0.294    0.375    0.066    1.535    0.004       beta(1,1)
#>  .y2 ~~                                                                        
#>    .y4                0.243    0.731   -0.031    2.833    0.005       beta(1,1)
#>    .y6                0.343    0.760    0.762    3.747    0.013       beta(1,1)
#>  .y3 ~~                                                                        
#>    .y7                0.207    0.654   -0.147    2.419    0.006       beta(1,1)
#>  .y4 ~~                                                                        
#>    .y8                0.100    0.478   -0.450    1.421    0.005       beta(1,1)
#>  .y6 ~~                                                                        
#>    .y8                0.312    0.615    0.252    2.664    0.006       beta(1,1)
#> 
#> Variances:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>     ind60             0.469    0.094    0.314    0.682    0.006      gamma(1,1)
#>    .dem60             3.535    0.840    5.397    2.113    0.009     gamma(1,.9)
#>    .dem65             0.344    0.197    4.329    0.058    0.026     gamma(1,.5)
#>    .x1                0.085    0.020    0.196    0.050    0.017 gamma(1,.5)[sd]
#>    .x2                0.132    0.066    1.315    0.026    0.034 gamma(1,.5)[sd]
#>    .x3                0.491    0.095    0.332    0.704    0.003 gamma(1,.5)[sd]
#>    .y1                2.041    0.506    4.731    1.188    0.011 gamma(1,.5)[sd]
#>    .y2                7.765    1.479    5.274   11.049    0.003 gamma(1,.5)[sd]
#>    .y3                5.309    1.041    3.580    7.644    0.002 gamma(1,.5)[sd]
#>    .y4                3.236    0.823    8.060    1.829    0.011 gamma(1,.5)[sd]
#>    .y5                2.497    0.529    3.679    1.616    0.005 gamma(1,.5)[sd]
#>    .y6                5.199    0.980    3.554    7.381    0.003 gamma(1,.5)[sd]
#>    .y7                3.567    0.771    5.285    2.279    0.007 gamma(1,.5)[sd]
#>    .y8                3.366    0.760    5.048    2.080    0.006 gamma(1,.5)[sd]
```
