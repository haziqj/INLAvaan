...
The `{blavaan}` package is able to implement [WAICs and LOOs](https://blavaan.org/articles/model_comparison.html) as alternative model comparison metrics, and these will hopefully also be implemented in future versions of `{INLAvaan}`.
