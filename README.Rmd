...
> Jamil, H (`r format(Sys.time(), "%Y")`). _INLAvaan: Bayesian structural equation modelling with INLA_. R package version `r packageVersion("INLAvaan")`. URL: <https://inlavaan.haziqj.ml/>
