...
options(cli.dynamic = FALSE, cli.ansi = FALSE, cli.progress_show_after = 2)
...
Following the official instructions given [here](https://www.r-inla.org/download/), install the package by running this command in R:
