...
#> ✔ Finding posterior mode. [15ms]
#> 
#> ℹ Computing the Hessian.
#> ✔ Computing the Hessian. [15ms]
#> 
#> ℹ Performing VB correction.
#> ✔ VB correction; mean |δ| = 0.246σ. [45ms]
#> 
#> ⠙ Fitting 0/6 skew-normal marginals.
#> ✔ Fitting 6/6 skew-normal marginals. [49ms]
#> 
#> ℹ Adjusting copula correlations (NORTA).
#> ✔ Adjusting copula correlations (NORTA). [16ms]
#> 
#> ⠙ Posterior sampling and summarising.
#> ✔ Posterior sampling and summarising. [267ms]
#> 
