...
- fit_measures:
  ...
  `"p_loo"` and `"looic"` (see
  [`loo()`](https://inlavaan.haziqj.ml/reference/loo.md)), and the WAIC
  measures `"elpd_waic"`, `"se_waic"`, `"p_waic"` and `"waic"` (see
  [`waic()`](https://inlavaan.haziqj.ml/reference/waic.md)), are
  ...
  directly) for repeated access. INLAvaan's stable spelling
  `fit.measures` is also accepted.
...
#>           21    -3848.489        0.000     7553.859       21.346        0.117 
