...
#> ✔ Finding posterior mode. [381ms]
#> 
#> ℹ Computing the Hessian.
#> ✔ Computing the Hessian. [385ms]
#> 
#> ℹ Performing VB correction.
#> ✔ Performing VB correction. [353ms]
#> 
...
#> 
summary(fit)
#> INLAvaan 0.2.1.9002 ended normally after 56 iterations
#> 
#>   Estimator                                      BAYES
...
#> 
#>    Deviance (DIC)                             7515.889 
#>    Effective parameters (pD)                    20.070 
#> 
#> Parameter Estimates:
#> 
