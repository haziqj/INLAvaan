...
#> ✔ VB correction; mean |δ| = 0.013σ. [154ms]
#> 
#> ⠙ Fitting skew normal to 0/21 marginals.
#> ✔ Fitting skew normal to 21/21 marginals. [970ms]
#> 
#> ⠙ Computing ppp and DIC.
#> ✔ Computing ppp and DIC. [93ms]
#> 
summary(fit)
...
#> 
#>    Deviance (DIC)                             7581.673 
#>    Effective parameters (pD)                    52.966 
#> 
#> Parameter Estimates:
#> 
