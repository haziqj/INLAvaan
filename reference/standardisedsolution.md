...
#> 1   visual =~      x1   0.744 0.058    0.632    0.847
#> 2   visual =~      x2   0.413 0.057    0.284    0.521
#> 3   visual =~      x3   0.580 0.057    0.467    0.690
#> 4  textual =~      x4   0.845 0.024    0.794    0.888
#> 5  textual =~      x5   0.852 0.024    0.804    0.894
#> 6  textual =~      x6   0.836 0.025    0.784    0.888
#> 7    speed =~      x7   0.553 0.056    0.465    0.667
#> 8    speed =~      x8   0.714 0.059    0.601    0.820
#> 9    speed =~      x9   0.669 0.065    0.551    0.786
#> 10      x1 ~~      x1   0.444 0.087    0.282    0.600
#> 11      x2 ~~      x2   0.826 0.046    0.729    0.919
#> 12      x3 ~~      x3   0.660 0.067    0.524    0.782
#> 13      x4 ~~      x4   0.285 0.040    0.211    0.370
#> 14      x5 ~~      x5   0.273 0.040    0.201    0.354
#> 15      x6 ~~      x6   0.300 0.043    0.212    0.385
#> 16      x7 ~~      x7   0.691 0.063    0.555    0.784
#> 17      x8 ~~      x8   0.487 0.084    0.327    0.639
#> 18      x9 ~~      x9   0.548 0.087    0.382    0.696
#> 19  visual ~~  visual   1.000 0.000    1.000    1.000
#> 20 textual ~~ textual   1.000 0.000    1.000    1.000
#> 21   speed ~~   speed   1.000 0.000    1.000    1.000
#> 22  visual ~~ textual   0.434 0.066    0.284    0.542
#> 23  visual ~~   speed   0.468 0.082    0.321    0.618
#> 24 textual ~~   speed   0.274 0.068    0.134    0.405
```
