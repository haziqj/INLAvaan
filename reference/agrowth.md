...
#> ✔ VB correction; mean |δ| = 0.004σ. [257ms]
#> 
...
#>    PPP (Chi-square)                              0.790 
#> 
#> Information Criteria:
#> 
#>    Deviance (DIC)                             5006.528 
#>    Effective parameters (pD)                    22.090 
#> 
#> Parameter Estimates:
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .i ~~                                                                         
#>    .s                 0.161    0.041    0.146   -0.015    0.005       beta(1,1)
#> 
#> Intercepts:
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>    .t1                0.000                                                    
