...
#> ✔ Computing the Hessian. [655ms]
#> 
#> ℹ Performing VB correction.
#> ✔ Performing VB correction. [587ms]
#> 
...
#> ✔ Sampling covariances and defined parameters. [337ms]
#> 
summary(fit)
#> INLAvaan 0.2.0.9007 ended normally after 70 iterations
#> 
#>   Estimator                                      BAYES
...
#>   ind60 =~                                                            
#>     x1                1.000                                           
#>     x2                2.210    0.146    1.942    2.513    normal(0,10)
#>     x3                1.842    0.156    1.537    2.150    normal(0,10)
#>   dem60 =~                                                            
#>     y1                1.000                                           
#>     y2         (a)    1.206    0.149    0.929    1.514    normal(0,10)
#>     y3         (b)    1.188    0.125    0.950    1.441    normal(0,10)
#>     y4         (c)    1.267    0.126    1.023    1.518    normal(0,10)
#>   dem65 =~                                                            
#>     y5                1.000                                           
#>     y6         (a)    1.206    0.149    0.929    1.514    normal(0,10)
#>     y7         (b)    1.188    0.125    0.950    1.441    normal(0,10)
#>     y8         (c)    1.267    0.126    1.023    1.518    normal(0,10)
#> 
#> Regressions:
#>                    Estimate       SD     2.5%    97.5%    Prior       
#>   dem60 ~                                                             
#>     ind60             1.474    0.396    0.699    2.250    normal(0,10)
#>   dem65 ~                                                             
#>     ind60             0.597    0.241    0.121    1.065    normal(0,10)
#>     dem60             0.863    0.075    0.719    1.014    normal(0,10)
#> 
#> Covariances:
#>                    Estimate       SD     2.5%    97.5%    Prior       
#>  .y1 ~~                                                               
#>    .y5                0.281    0.378    0.011    1.496       beta(1,1)
#>  .y2 ~~                                                               
#>    .y4                0.274    0.706    0.113    2.882       beta(1,1)
#>    .y6                0.343    0.704    0.945    3.711       beta(1,1)
#>  .y3 ~~                                                               
#>    .y7                0.184    0.648   -0.336    2.211       beta(1,1)
#>  .y4 ~~                                                               
#>    .y8                0.107    0.464   -0.417    1.403       beta(1,1)
#>  .y6 ~~                                                               
#>    .y8                0.312    0.581    0.294    2.571       beta(1,1)
#> 
#> Variances:
#>                    Estimate       SD     2.5%    97.5%    Prior       
#>    .x1                0.087    0.020    0.053    0.133 gamma(1,.5)[sd]
#>    .x2                0.132    0.074    0.031    0.312 gamma(1,.5)[sd]
#>    .x3                0.498    0.097    0.339    0.718 gamma(1,.5)[sd]
#>    .y1                2.011    0.492    1.216    3.132 gamma(1,.5)[sd]
#>    .y2                7.928    1.469    5.517   11.254 gamma(1,.5)[sd]
#>    .y3                5.221    1.035    3.523    7.562 gamma(1,.5)[sd]
#>    .y4                3.362    0.803    2.068    5.197 gamma(1,.5)[sd]
#>    .y5                2.485    0.527    1.625    3.682 gamma(1,.5)[sd]
#>    .y6                5.160    0.972    3.563    7.360 gamma(1,.5)[sd]
#>    .y7                3.729    0.784    2.443    5.500 gamma(1,.5)[sd]
#>    .y8                3.384    0.754    2.158    5.095 gamma(1,.5)[sd]
#>     ind60             0.453    0.090    0.307    0.660 gamma(1,.5)[sd]
#>    .dem60             3.932    0.923    2.465    6.059 gamma(1,.5)[sd]
#>    .dem65             0.280    0.205    0.034    0.796 gamma(1,.5)[sd]
#> 
```
