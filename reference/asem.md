...
#> ✔ VB correction; mean |δ| = 0.045σ. [220ms]
#> 
...
#>                    Estimate       SD     2.5%    97.5%     NMAD    Prior       
#>  .y1 ~~                                                                        
#>    .y5                0.269    0.407   -0.021    1.567    0.003       beta(1,1)
#>  .y2 ~~                                                                        
#>    .y4                0.273    0.697    0.165    2.902    0.006       beta(1,1)
#>    .y6                0.345    0.716    0.864    3.673    0.018       beta(1,1)
#>  .y3 ~~                                                                        
#>    .y7                0.177    0.644   -0.392    2.138    0.005       beta(1,1)
#>  .y4 ~~                                                                        
#>    .y8                0.105    0.449   -0.467    1.295    0.005       beta(1,1)
#>  .y6 ~~                                                                        
